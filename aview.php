...
<form name="form1" action="" method="post">
	<h3 style="font-family: verdana;font-size:200%;color: blue;text-align: center;" ><u><b>View Admin details</b></u><h3>
...
if(isset($_POST["submit1"]))
	...
	$res=mysqli_query($link,"select * from aregister");
	     echo "<table border=1>";
         echo "<tr>";
         echo "<th>"; echo "Admin-id";     echo "</th>";
         echo "<th>"; echo "Admin name";   echo "</th>";
...
if(isset($_POST["submit2"]))
	...
	$res=mysqli_query($link,"select * from aregister where id=('$_POST[id]')");
         echo "<table border=1>";
         echo "<tr>";
         echo "<th>"; echo "Admin-id";     echo "</th>";
         echo "<th>"; echo "Admin name";   echo "</th>";
